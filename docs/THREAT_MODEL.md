...
| T10 | Dependency/build/DLL drift | Test evidence attached to different executable/runtime | Platform PEP 751 locks, source-tree hash, Git/diff identity, DLL hash and target runtime in manifests | RC2 exact-lock evidence remains historical; current U1 `0.8.3-u1` exact-source reload binds deployed Session-1 bridge SHA-256 `0245e91f…2661a`, while a future published RC3 release still requires its own release-provenance certification | Release owner |
